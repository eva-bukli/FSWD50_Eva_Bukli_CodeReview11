<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item px-4 dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Upload</a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="rcreate.php">Upload Restaurant</a>
          <a class="dropdown-item"href="ccreate.php">Upload Concert</a>
          <a class="dropdown-item" href="tcreate.php">Upload Things To Do</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item"href="change.php">Edit Location</a>
        </div>
      </li>
      <li class="nav-item px-4">
